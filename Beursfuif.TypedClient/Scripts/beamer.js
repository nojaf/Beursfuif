...
var beursfuif;
(function (beursfuif) {
    beursfuif.beamerModule = angular.module("beamer", ["ngRoute", "ngAnimate", "ngSanitize", "LocalStorageModule"]);
})(beursfuif || (beursfuif = {}));
...
(function (beursfuif) {
    var SignalRMethodNames = (function () {
        ...
        SignalRMethodNames.UPDATE_TIME = "updateTime"; //(currentTime, authenticationCode);
    ...
    var SignalrService = (function () {
        ...
        SignalrService.prototype.registerCallback = function () {
            var _this = this;
            this.hub.on(SignalRMethodNames.SEND_INITIAL_DATA, function (currentTime, clientInterval) { return _this.sendInitialData(currentTime, clientInterval); });
            this.hub.on(SignalRMethodNames.UPDATE_TIME, function (currentTime, authenticationCode) { return _this.updateTime(currentTime, authenticationCode); });
            this.hub.on(SignalRMethodNames.YOU_GOT_KICKED, function () { return _this.kicked(); });
            this.hub.on(SignalRMethodNames.ACK_NEW_ORDER, function () { return _this.showToast(); });
            this.hub.on(SignalRMethodNames.UPDATE_INTERVAL, function (clientInterval, currentBFTime) { return _this.updateInterval(clientInterval, currentBFTime); });
            this.hub.on(SignalRMethodNames.DRINK_AVAILABLE_CHANGED, function (clientInterval) { return _this.drinkAvailableChanged(clientInterval); });
        };
    ...
    var BeamerCtrl = (function () {
        function BeamerCtrl($scope, localStorageService, signalrService) {
            ...
            $scope.$on(beursfuif.EventNames.CONNECTION_CHANGED, function (e) {
                ...
                _this.connectionChanged(e, msg);
            });
            $scope.$on(beursfuif.EventNames.TIME_CHANGED, function (e) {
                var msg = [];
                for (var _i = 1; _i < arguments.length; _i++) {
                    msg[_i - 1] = arguments[_i];
                }
        ...
        BeamerCtrl.prototype.parseImage = function (imgString) {
            if (imgString) {
        ...
        BeamerCtrl.prototype.connectionChanged = function (e) {
            var msg = [];
            for (var _i = 1; _i < arguments.length; _i++) {
                msg[_i - 1] = arguments[_i];
            }
        ...
        BeamerCtrl.prototype.bindDrinks = function () {
            this.$scope.drinks = [];
        ...
        BeamerCtrl.prototype.updateTime = function () {
            this.calculateProgress();
        };
        BeamerCtrl.prototype.calculateProgress = function () {
            var start = moment(this.signalrService.clientInterval.Start);
