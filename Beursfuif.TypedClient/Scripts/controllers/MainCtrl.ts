module beursfuif {
    ...
    beursfuifModule.controller("MainCtrl", ["$scope", "SignalrService", "$location","$timeout",
        ($scope: IMainCtrlScope, signalrService: SignalrService, $location: ng.ILocationService, $timeout:ng.ITimeoutService) => {
