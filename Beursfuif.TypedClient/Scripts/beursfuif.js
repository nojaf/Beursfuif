...
(function (beursfuif) {
    var MainCtrl = (function () {
        function MainCtrl($scope, signalrService, $location, $timeout) {
            this.$scope = $scope;
            this.signalrService = signalrService;
            this.$location = $location;
            this.$timeout = $timeout;
        ...
        MainCtrl.prototype.dataBind = function () {
            ...
            this.$timeout(function () {
                ...
                _this.$scope.intervalStart = moment(_this.signalrService.clientInterval.Start).format("HH:mm");
                _this.$scope.intervalEnd = moment(_this.signalrService.clientInterval.End).format("HH:mm");
                _this.$scope.currentTime = moment(_this.signalrService.currentTime).format("HH:mm");
            }, 200);
        };
        MainCtrl.prototype.parseImage = function (imgString) {
            if (imgString) {
